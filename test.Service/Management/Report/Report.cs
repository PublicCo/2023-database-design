...
namespace test.Service.Management.Report
{
    public class ReportService: IReportService
    {
        ...
        public List<report_info> GetReport()
        {
            ...
            report_Infos = DbContext.db.Queryable<report_info>().Where(it => it.message_state == 0).ToList();
            return report_Infos;
        }
        /// <summary>
        /// 将举报信息修改为已处理（单条）
