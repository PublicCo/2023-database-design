...
builder.Services.AddTransient<INuclearTest, NuclearTest>();
builder.Services.AddTransient<IUserHealthState, UserHealthState>();
builder.Services.AddTransient<IVaccineInfo, VaccineInfo>();
